...
-- Add category_key to used_spare_parts for new category system
ALTER TABLE used_spare_parts ADD COLUMN category_key VARCHAR(50) DEFAULT NULL; 

-- Remove legacy category columns from used_spare_parts
ALTER TABLE used_spare_parts DROP COLUMN IF EXISTS category_en;
ALTER TABLE used_spare_parts DROP COLUMN IF EXISTS category_it; 
