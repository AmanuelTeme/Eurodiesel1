...
const EmployeesList = () => {
      ...
      if (Array.isArray(res.data.employees)) {
        ...
        for (const key in res.data) {
          if (Array.isArray(res.data[key])) {
            employeesArray = res.data[key];
            break;
          }
        }
      }
      // Flatten if it's an array of arrays
      if (Array.isArray(employeesArray[0])) {
        employeesArray = employeesArray.flat();
      }
  ...
  const filteredEmployees = employees.filter((employee) => {
    const isActive = showActiveEmployees
      ...
      : !employee.active_employee;
    // Make search more robust: check all fields, ignore case and trim
                          ...
                          <tr key={employee.employee_id}>
                            ...
                            <td>
                              <div className="action-icons">
                                ...
                                <Link
                                  onClick={() =>
                                    handleShowDeleteModal(employee)
                                  }
                                >
                                  <i
