...
const OrderDetail = () => {
  ...
  const handleUpdateSpace = async () => {
    ...
    if (
      ...
      Array.isArray(order.order_services) &&
    ...
    let order_description =
      ...
      (orderData &&
        ...
        orderData[0]?.order_description) ||
      (orderData &&
        Array.isArray(orderData) &&
        orderData[0]?.orderDescription) ||
      (orderDetails &&
        (orderDetails.order_description || orderDetails.orderDescription)) ||
      "No description";
  ...
  const handleMarkCompleted = async () => {
    ...
    try {
      ...
      setSpaceError(
        error.response?.data?.error || "Failed to mark as completed"
      );
    }
  };
          ...
          <div className="col-12">
            <div className="inner-boxx hvr-float-shadow">
              ...
              <div className="mt-2">
                ...
                <select
                  id="space-select"
                  value={selectedSpace || order.space_id || ""}
                ...
                <button
                  ...
                  disabled={
                    !selectedSpace ||
                    selectedSpace == order.space_id ||
                    (selectedSpace &&
                      spaces.find((s) => s.space_id == selectedSpace)
                ...
                {spaceNotification && (
                  <div style={{ color: "green" }}>{spaceNotification}</div>
                )}
